...
/**
 * Pure inline SVG icons for enterprise financial design.
 * No external icon libraries used.
 */

export function LogoIcon({ className = "w-6 h-6", goldColor = "#C99A4A", navyColor = "#071E2B" }) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M16 2L4 7V15C4 22.5 9.1 29.5 16 31C22.9 29.5 28 22.5 28 15V7L16 2Z" fill={navyColor} stroke={goldColor} strokeWidth="1.5" />
      <path d="M11 16L15 20L21 12" stroke={goldColor} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
      <circle cx="16" cy="7" r="1.5" fill={goldColor} />
    </svg>
  );
}
...
export function PredictIcon({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
...
export function CustomersIcon({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
...
export function InfoIcon({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75">
      <circle cx="12" cy="12" r="9" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 8.25h.01M12 11.25v5.25" />
    </svg>
  );
}
...
export function SpinnerIcon({ className = "w-4 h-4 animate-spin text-gold-primary" }) {
  return (
